...
class DAOPessoa:
    ...
    def adicionarPessoa(self):
        ...
        cadastrarFuncionarioEmpresa = input('Deseja vincular esse funcionario a empresa?').title()
        ...
        dados = novaPessoa.getNome(), novaPessoa.getEndereco(), novaPessoa.getBairro(), novaPessoa.getCep()\
            , novaPessoa.getCidade(), novaPessoa.getEstado(), novaPessoa.getIdEmpresa()
